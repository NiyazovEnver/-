...
$same_login_user = mysql_query("SELECT id FROM users WHERE login = '$login'", $db);
$same_login_row = mysql_fetch_array($same_login_user);
...
$result = mysql_query("INSERT INTO users (login,password,name) VALUES ('$login','$password','$name')");

# если ошибок нет функция mysql_query вернёт значение 'TRUE'
if ($result == 'TRUE') {
