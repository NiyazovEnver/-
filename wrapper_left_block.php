...
<div id="wrapper_left_block">
	...
	else
	{
		...
		$is_admin_q = mysql_query("SELECT is_admin FROM users WHERE id='$session_id'", $db);
		$user_row = mysql_fetch_array($is_admin_q);
...
?>
	...
	<div id="wrapper_left_block_down" style="text-align: center;">
		...
		<a class="wrapper_left__calc" href="calculator.php">Калькулятор производных</a>
		<?php
			if ($user_row['is_admin'] == '1'){
			?>
